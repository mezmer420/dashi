...
module.exports.run = async ({ client, interaction }) => {
	...
	if (
		targetChannel.id !== "939674946953682976" && // general
		targetChannel.id !== "939686071241949205" && // bot-related
		// targetChannel.id !== "940786577808969738" && // games
		targetChannel.id !== "945527434655187006" // spam
		// targetChannel.id !== "969027553878749204" // nerd
	) {
		return await interaction
			.editReply({
				content:
					"You can only set the target channel to <#939674946953682976>, <#939686071241949205>, or <#945527434655187006>",
			})
			.catch((err) => {})
	}
